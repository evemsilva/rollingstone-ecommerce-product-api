...
public class ProductController
	...
	Product product = returnedProduct.orElseThrow(() -> new HTTP404Exception("Resource Not Found"));
    ...
    @GetMapping("/product")
    public @ResponseBody
    Page<Product> getProductsByPage(@RequestParam(value = "pagenumber", defaultValue = DEFAULT_PAGE_NUMBER) Integer pageNumber,
