...
import static com.rollingstone.spring.controller.AbstractController.*;
...
public class ProductController extends AbstractController {
   ...
   public @ResponseBody Page<Product> getProductsByPage(
		   @RequestParam(value="pagenumber", required=true, defaultValue= DEFAULT_PAGE_NUMBER) Integer pageNumber,
